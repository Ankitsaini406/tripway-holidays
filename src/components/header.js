                ...
                <nav className={`${styles.desktop} ${styles.headeritems}`}>
                    <ul className={styles.headerList}>
                        ...
                        {user ? (
                            ...
                            <li><Link href="/auth/user/login" className={styles.headerButton}>Login</Link></li>
                        )}
                    </ul>
                </nav>
                <nav className={`${styles.mobile} ${styles.headeritems} ${isMenuOpen ? styles.open : ''}`}>
                    ...
                    <li className={styles.dropdownContainer}>
                        ...
                        {user ? (
                            ...
                            <li><Link href="/auth/user/login" className={styles.headerButton} onClick={closeMenu}>Login</Link></li>
                        )}
                    </ul>
                </nav>
            </div>
