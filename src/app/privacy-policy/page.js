...
const PrivacyPolicy = () => {
    return (
        ...
        >
            ...
            <h2 className={styles.h2Tag}>Interpretation and Definitions</h2>

            <h3 className={styles.h3Tag}>Interpretation</h3>
            <p>
            ...
            <h3 className={styles.h3Tag}>Definitions</h3>
            ...
            <ul className={styles.ulTag}>
                <li className={styles.liTag}>Email address</li>
                <li className={styles.liTag}>First name and last name</li>
                <li className={styles.liTag}>Phone number</li>
                <li className={styles.liTag}>
            ...
            <ul className={styles.ulTag}>
                <li className={styles.liTag}>Google</li>
                <li className={styles.liTag}>FaceBook</li>
                <li className={styles.liTag}>Instagram</li>
                <li className={styles.liTag}>Twitter</li>
                <li className={styles.liTag}>Linkedin</li>
            </ul>
            <p>
            ...
            <h2 className={styles.h2Tag}>Use of Your Personal Data</h2>
            ...
            <h2 className={styles.h2Tag}>Retention of Your Personal Data</h2>
            <p>
            ...
            <h3 className={styles.h3Tag}>Transfer of Your Personal Data</h3>
            <p>
            ...
            <h3 className={styles.h3Tag}>Delete Your Personal Data</h3>
            <p>
            ...
            <ul className={styles.ulTag}>
                <li className={styles.liTag}>Comply with a legal obligation</li>
                <li className={styles.liTag}>
                ...
                <li className={styles.liTag}>Protect against legal liability</li>
            </ul>

            <h3 className={styles.h3Tag}>Security of Your Personal Data</h3>
            <p>
            ...
            <h2 className={styles.h2Tag}>Children&apos;s Privacy</h2>
            <p>
            ...
            <h2 className={styles.h2Tag}>Links to Other Websites</h2>
            <p>
                Our Service contains links to websites not operated by us. We strongly
            ...
            <h2 className={styles.h2Tag}>Changes to this Privacy Policy</h2>
            <p>
            ...
            <h2 className={styles.h2Tag}>Contact Us</h2>
            <p>
